  ...
  cached = [
    ...
    ...(renderOwner()
      ? [
          '',
          '## In my own words',
          'Kim wrote these answers himself. Use them when they fit the question,',
          'and stay close to his wording — this is the one part of the corpus that',
          'is his opinion rather than a checkable fact.',
          '',
          renderOwner()
        ]
      : []),
